...
public:
    ...
    virtual bool load()
    {
        AgentMeta::SetTotalSignature(1259568331u);
        ...
        // aiVoiceAgent
        meta = BEHAVIAC_NEW AgentMeta(234224125u);
        AgentMeta::GetAgentMetas()[2996450326u] = meta;
        meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_aiVoiceAgent_LogMessage));
        meta->RegisterMethod(1505908390u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_aiVoiceAgent_SayHello));
        meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
        meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
        meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
        meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
        ...
        AgentMeta::Register<aiVoiceAgent>("aiVoiceAgent");
    ...
    virtual bool unLoad()
    {
        ...
        AgentMeta::UnRegister<aiVoiceAgent>("aiVoiceAgent");
